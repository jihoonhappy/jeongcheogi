#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────
# 음성 MP3(60트랙 약 188MB)를 GitHub Releases 로 올립니다.
#
#   bash tools/upload_audio_release.sh
#
# 왜 릴리스인가
...
[ "$n" -eq 60 ] || echo "   ⚠️  60개가 아닙니다. 음성 생성이 덜 됐는지 확인하세요."
...
echo "▶ 3/3  업로드합니다. 약 188MB — 회선에 따라 몇 분 걸립니다."
